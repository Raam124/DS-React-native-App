        ...
        <ScrollView>
          ...
          {this.state.defaultBox === "colorBox" ? (
            <ChoosingSizeBox
              ...
              secondItem="medium"
              thirdItem="small"
              onPressFirst={() => this.onChooseColor("large")}
              onPressSecond={() => this.onChooseColor("medium")}
              onPressThird={() => this.onChooseColor("small")}
            />
          ) : (
            <ChoosingSizeBox
              label="Choosing a brand"
              top={this.sizeBox}
              opacity={animatedSizeBoxOpacity}
              firstItem="China"
              secondItem="UK"
              thirdItem="US"
              onPressFirst={() => this.onChooseItem("China")}
              onPressSecond={() => this.onChooseItem("UK")}
              onPressThird={() => this.onChooseItem("US")}
            />
          )}
          {/* ChoosingSizeBox */}
          ...
          >
            ...
            >
              ...
              >
                Covid-19 is a global pandemic now so this kit allows you to be safe from that
              </Text>
            </View>
            {/* upper */}
            {/* lower */}
          ...
          >
            ...
            >
              ...
              >
                We take fully responsible that this product is more reliable and cheaper according to current market
              </Text>
              {/* right_down */}
            </View>
            {/* right */}
